...
def gcgru_model(features, labels, conv_matrix, mode, params):
    ...
    encoder_cells = [GCGRU(params.hidden_size,activation = tf.nn.tanh,
                                conv_matrix = conv_matrix) for _ in range(params.n_layers)]
    ...
    decoder_cells = [GCGRU(params.hidden_size,activation = tf.nn.tanh,
                                conv_matrix = conv_matrix) for _ in range(params.n_layers)]
